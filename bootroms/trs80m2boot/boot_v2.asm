; TRS-80 Model II boot ROM, rev 2, reconstructed source code
...
; reset HDC and check for drive presence
	...
	out	(hdc_control_reg),a
	ld	a,hdc_control_deven+hdc_control_wait_enable
	out	(hdc_control_reg),a
...
; clear screen (all 020h)
	...
	call	terminate_fdc_cmd
	ld	a,fdc_cmd_restore+fdc_cmd_head_load+fdc_cmd_verify_track+fdc_cmd_step_rate_10ms
	out	(fdc_cmd_reg),a
...
hd_busy:
	...
	ld	a,008h		; pretend we got an "id not found" error
	or	a		; clear Z in status register
	pop	bc
	ret
