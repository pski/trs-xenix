...
l0050h:
	...
	or c			;0055	b1 	. 
	ld a,d			;0056	7a 	z 
	jr nz,l0050h		;0057	20 f7 	  . 
	or a			;0059	b7 	. 
	jp nz,l027fh		;005a	c2 7f 02 	.  . 
	ld a,055h		;005d	3e 55 	> U 
	cpl			;005f	2f 	/ 
	or a			;0060	b7 	. 
	and a			;0061	a7 	. 
	ld b,a			;0062	47 	G 
	...
	ex af,af'			;007a	08 	. 
	cp l			;007b	bd 	. 
	jp nz,l0284h		;007c	c2 84 02 	. . . 
	ld bc,07000h		;007f	01 00 70 	. . p 
...
l0087h:
	...
	cpl			;008b	2f 	/ 
	ld (hl),a			;008c	77 	w 
	jp nz,l0289h		;008d	c2 89 02 	. . . 
	ldi		;0090	ed a0 	. . 
	jp pe,l0087h		;0092	ea 87 00 	. . . 
	ld d,0c8h		;0095	16 c8 	. . 
l0097h:
	in a,(0ffh)		;0097	db ff 	. . 
	bit 7,a		;0099	cb 7f 	.  
	jr z,l009fh		;009b	28 02 	( . 
	in a,(0fch)		;009d	db fc 	. . 
l009fh:
	ld bc,00080h		;009f	01 80 00 	. . . 
	call sub_02c8h		;00a2	cd c8 02 	. . . 
	dec d			;00a5	15 	. 
	jr nz,l0097h		;00a6	20 ef 	  . 
	xor a			;00a8	af 	. 
	out (0c1h),a		;00a9	d3 c1 	. . 
	ld a,000h		;00ab	3e 00 	> . 
	out (0c1h),a		;00ad	d3 c1 	. . 
	ld a,00fh		;00af	3e 0f 	> . 
	out (0c1h),a		;00b1	d3 c1 	. . 
	in a,(0c2h)		;00b3	db c2 	. . 
	and 00fh		;00b5	e6 0f 	. . 
	jr z,l00dah		;00b7	28 21 	( ! 
	ld bc,l0438h		;00b9	01 38 04 	. 8 . 
l00bch:
	ld a,c			;00bc	79 	y 
	out (0ceh),a		;00bd	d3 ce 	. . 
	ld a,01fh		;00bf	3e 1f 	> . 
	out (0cfh),a		;00c1	d3 cf 	. . 
	call sub_02f7h		;00c3	cd f7 02 	. . . 
	xor a			;00c6	af 	. 
	out (0cdh),a		;00c7	d3 cd 	. . 
	ld a,005h		;00c9	3e 05 	> . 
	out (0cch),a		;00cb	d3 cc 	. . 
	ld a,073h		;00cd	3e 73 	> s 
	out (0cfh),a		;00cf	d3 cf 	. . 
	call sub_02f7h		;00d1	cd f7 02 	. . . 
	ld a,c			;00d4	79 	y 
	sub 008h		;00d5	d6 08 	. . 
	ld c,a			;00d7	4f 	O 
	djnz l00bch		;00d8	10 e2 	. . 
l00dah:
...
l013dh:
	in a,(0cfh)		;013d	db cf 	. . 
	bit 3,a		;013f	cb 5f 	. _ 
	jr z,l013dh		;0141	28 fa 	( . 
	call sub_02e8h		;0143	cd e8 02 	. . . 
	jr z,l01b5h		;0146	28 6d 	( m 
	inc b			;0148	04 	. 
	push bc			;0149	c5 	. 
	...
	call sub_02c8h		;0163	cd c8 02 	. . . 
	call sub_02e8h		;0166	cd e8 02 	. . . 
	jr z,l01b5h		;0169	28 4a 	( J 
	xor a			;016b	af 	. 
...
l01b5h:
	...
	xor a			;01b8	af 	. 
	out (0c1h),a		;01b9	d3 c1 	. . 
	ld a,04eh		;01bb	3e 4e 	> N 
	out (0efh),a		;01bd	d3 ef 	. . 
	ld hl,0035ah		;01bf	21 5a 03 	! Z . 
	ld de,0fb8eh		;01c2	11 8e fb 	. . . 
	ld bc,00011h		;01c5	01 11 00 	. . . 
	ldir		;01c8	ed b0 	. . 
l01cah:
	call sub_02ceh		;01ca	cd ce 02 	. . . 
	bit 7,a		;01cd	cb 7f 	.  
	jr nz,l01cah		;01cf	20 f9 	  . 
	ld bc,l07ffh		;01d1	01 ff 07 	. . . 
	ld de,0fffeh		;01d4	11 fe ff 	. . . 
	ld hl,0ffffh		;01d7	21 ff ff 	! . . 
	ld (hl),020h		;01da	36 20 	6   
	lddr		;01dc	ed b8 	. . 
	call sub_02ceh		;01de	cd ce 02 	. . . 
	ld a,00bh		;01e1	3e 0b 	> . 
	out (0e4h),a		;01e3	d3 e4 	. . 
	ld d,007h		;01e5	16 07 	. . 
l01e7h:
	call sub_02c8h		;01e7	cd c8 02 	. . . 
	in a,(0e4h)		;01ea	db e4 	. . 
	bit 0,a		;01ec	cb 47 	. G 
	jr z,l01f3h		;01ee	28 03 	( . 
	dec d			;01f0	15 	. 
	jr nz,l01e7h		;01f1	20 f4 	  . 
l01f3h:
	in a,(0e4h)		;01f3	db e4 	. . 
	push af			;01f5	f5 	. 
	xor 004h		;01f6	ee 04 	. . 
	and 015h		;01f8	e6 15 	. . 
	jr nz,l0270h		;01fa	20 74 	  t 
	pop af			;01fc	f1 	. 
	bit 7,a		;01fd	cb 7f 	.  
	jr nz,l0275h		;01ff	20 74 	  t 
	bit 3,a		;0201	cb 5f 	. _ 
	jr nz,l027ah		;0203	20 75 	  u 
...
l0211h:
	...
	push de			;0212	d5 	. 
	push bc			;0213	c5 	. 
	call sub_02ceh		;0214	cd ce 02 	. . . 
	ld a,c			;0217	79 	y 
	out (0e6h),a		;0218	d3 e6 	. . 
	ex af,af'			;021a	08 	. 
	out (0e4h),a		;021b	d3 e4 	. . 
	ex af,af'			;021d	08 	. 
	call sub_02c5h		;021e	cd c5 02 	. . . 
	pop bc			;0221	c1 	. 
	push bc			;0222	c5 	. 
	ld c,0e7h		;0223	0e e7 	. . 
l0225h:
	in a,(0e4h)		;0225	db e4 	. . 
	bit 1,a		;0227	cb 4f 	. O 
	jr z,l022fh		;0229	28 04 	( . 
	ini		;022b	ed a2 	. . 
	jr z,l0233h		;022d	28 04 	( . 
l022fh:
	bit 0,a		;022f	cb 47 	. G 
	jr nz,l0225h		;0231	20 f2 	  . 
l0233h:
	pop bc			;0233	c1 	. 
	pop de			;0234	d1 	. 
	in a,(0e4h)		;0235	db e4 	. . 
	and 01ch		;0237	e6 1c 	. . 
	jr z,l0249h		;0239	28 0e 	( . 
	pop hl			;023b	e1 	. 
	dec e			;023c	1d 	. 
	jr nz,l0211h		;023d	20 d2 	  . 
	bit 4,a		;023f	cb 67 	. g 
	jr nz,l028eh		;0241	20 4b 	  K 
	bit 3,a		;0243	cb 5f 	. _ 
	jr nz,l027ah		;0245	20 33 	  3 
	jr l0293h		;0247	18 4a 	. J 
l0249h:
	pop af			;0249	f1 	. 
	inc c			;024a	0c 	. 
	...
	ld hl,l034eh+1		;0250	21 4f 03 	! O . 
	ld de,01000h		;0253	11 00 10 	. . . 
	ld b,004h		;0256	06 04 	. . 
	call sub_02e0h		;0258	cd e0 02 	. . . 
	jr nz,l0298h		;025b	20 3b 	  ; 
	ld hl,0036bh		;025d	21 6b 03 	! k . 
	ld de,01400h		;0260	11 00 14 	. . . 
	ld b,004h		;0263	06 04 	. . 
	call sub_02e0h		;0265	cd e0 02 	. . . 
	jr nz,l0298h		;0268	20 2e 	  . 
	call 01404h		;026a	cd 04 14 	. . . 
	jp 01004h		;026d	c3 04 10 	. . . 
l0270h:
	ld de,04443h		;0270	11 43 44 	. C D 
	jr l029bh		;0273	18 26 	. & 
l0275h:
	ld de,04430h		;0275	11 30 44 	. 0 D 
	jr l029bh		;0278	18 21 	. ! 
l027ah:
	ld de,05343h		;027a	11 43 53 	. C S 
	jr l029bh		;027d	18 1c 	. . 
l027fh:
	ld de,0434bh		;027f	11 4b 43 	. K C 
	jr l029fh		;0282	18 1b 	. . 
l0284h:
	ld de,05a38h		;0284	11 38 5a 	. 8 Z 
	jr l029fh		;0287	18 16 	. . 
l0289h:
	ld de,04d46h		;0289	11 46 4d 	. F M 
	jr l029fh		;028c	18 11 	. . 
l028eh:
	ld de,0544bh		;028e	11 4b 54 	. K T 
	jr l029bh		;0291	18 08 	. . 
l0293h:
	ld de,04c44h		;0293	11 44 4c 	. D L 
	jr l029bh		;0296	18 03 	. . 
l0298h:
	ld de,05253h		;0298	11 53 52 	. S R 
l029bh:
	ld a,04fh		;029b	3e 4f 	> O 
	out (0efh),a		;029d	d3 ef 	. . 
l029fh:
	...
	bit 7,a		;02b5	cb 7f 	.  
	jr z,l02c3h		;02b7	28 0a 	( . 
	cp 01bh		;02b9	fe 1b 	. . 
	jp z,01004h		;02bb	ca 04 10 	. . . 
	cp 003h		;02be	fe 03 	. . 
	jp z,01004h		;02c0	ca 04 10 	. . . 
l02c3h:
	halt			;02c3	76 	v 
	rst 0			;02c4	c7 	. 
sub_02c5h:
...
sub_02ceh:
	push bc			;02ce	c5 	. 
	ld a,0d8h		;02cf	3e d8 	> . 
	out (0e4h),a		;02d1	d3 e4 	. . 
	ld a,0d0h		;02d3	3e d0 	> . 
	out (0e4h),a		;02d5	d3 e4 	. . 
	call sub_0319h		;02d7	cd 19 03 	. . . 
	in a,(0e7h)		;02da	db e7 	. . 
	in a,(0e4h)		;02dc	db e4 	. . 
	pop bc			;02de	c1 	. 
	ret			;02df	c9 	. 
sub_02e0h:
	ld a,(de)			;02e0	1a 	. 
	...
	ret			;02e7	c9 	. 
sub_02e8h:
	in a,(0ffh)		;02e8	db ff 	. . 
	xor 080h		;02ea	ee 80 	. . 
	bit 7,a		;02ec	cb 7f 	.  
	ret nz			;02ee	c0 	. 
	in a,(0fch)		;02ef	db fc 	. . 
	cp 01bh		;02f1	fe 1b 	. . 
	ret z			;02f3	c8 	. 
	cp 003h		;02f4	fe 03 	. . 
	ret			;02f6	c9 	. 
...
l02fbh:
	in a,(0cfh)		;02fb	db cf 	. . 
	bit 7,a		;02fd	cb 7f 	.  
	jr nz,l0305h		;02ff	20 04 	  . 
	bit 4,a		;0301	cb 67 	. g 
